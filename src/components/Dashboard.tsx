...
const Dashboard: React.FC<DashboardProps> = ({ levels, userProgress, onSelectLevel, onResetProgress }) => {
                    ...
                    <div className="text-left mb-4 sm:mb-0">
                     ...
                     <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                         <button
                            ...
                            className="bg-red-800 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm whitespace-nowrap"
                        >
                            Reiniciar Progreso
                        </button>
                    </div>
